...
if(EXISTS "${CGAL_DIR}" AND NOT "${CGAL_DIR}" STREQUAL "")
	...
	message(STATUS "CGAL ${CGAL_VERSION} found (include: ${CGAL_INCLUDE_DIRS})")
        FIND_PATH(CGAL_LIB_DIR
              NAMES CGAL
              HINTS
                  ENV CGAL_LIBRARY_DIRS
                  ${CGAL_LIBRARY_DIRS}
                  ${CGAL_DIR}/lib
                  ${CGAL_DIR}../lib
                  ${CGAL_INSTALLATION_PACKAGE_DIR}/lib
               PATH_SUFFIXES lib
               PATHS
                  ${MPIR_DIR}
                  /usr/lib
                  /usr/local/lib
          DOC "Path to the CGAL library"
          )

      if(CGAL_LIB_DIR)
          message(STATUS "CGAL LIB DIR found(lib: ${CGAL_LIB_DIR})")
      endif()
else()
