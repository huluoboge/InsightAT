...
| 需要了解 | 参考文件 |
|---------|---------|
| **基本概念** | [standards.md](standards.md) 第1部分 |
| **OmegaPhiKappa详解** | [standards.md](standards.md) 第2部分 |
| **与导航系统的区别** | [standards.md](standards.md) 第3、4部分 |
| **代码中的问题 / 如何改进 / 过程概览** | [imp-rotation-code-analysis.md](../../../dev-notes/imp/rotation/imp-rotation-code-analysis.md)、[归档总结](../../../dev-notes/archive/ROTATION_PROJECT_SUMMARY.md)（过程记录） |
...
| **Gimbal lock风险** | φ ≈ ±90° |
| **建议替代方案** | 四元数 |
| **文档位置** | `src/Common/ROTATION_*.md`（历史路径） |

---

**何时查看完整文档**：
- 😕 搞不清楚一个概念 → [standards.md](standards.md)
- 🐛 代码有问题 / 📊 过程概览 → [imp-rotation-code-analysis.md](../../../dev-notes/imp/rotation/imp-rotation-code-analysis.md)（以及[归档总结](../../../dev-notes/archive/ROTATION_PROJECT_SUMMARY.md)）
- ⚡ 需要快速答案 → 这个文件！
