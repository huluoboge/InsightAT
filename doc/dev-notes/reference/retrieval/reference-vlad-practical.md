...
**相关文档**：
- [VLAD快速入门](reference-vlad-quickstart.md) - 快速上手指南
- [Vocabulary Tree实践指南](../../tools/VOCAB_TREE_QUICKSTART.md) - BoW替代方案
- [isat_retrieve设计文档](../../design/retrieval/design-isat-retrieve.md) - 检索策略详解
