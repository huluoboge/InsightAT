...
- **详细设计**：[ImageGroup 设计](../design/imagegroup/design-imagegroup.md)
- **快速参考**：[IMAGEGROUP_SUMMARY.md](IMAGEGROUP_SUMMARY.md)
- **集成指南**：[ATTASK_IMAGEGROUP_INTEGRATION.md](../ATTASK_IMAGEGROUP_INTEGRATION.md) ⭐ 新增
