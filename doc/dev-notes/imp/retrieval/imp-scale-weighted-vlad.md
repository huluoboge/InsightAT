...
### 文档
7. [`reference-scale-weighted-vlad-usage.md`](../../reference/retrieval/reference-scale-weighted-vlad-usage.md)（使用参考）
   - 完整使用指南
   - 参数调优建议
   - 性能对比数据
   - 故障排除
...
## 参考
- 设计文档: [design-vlad.md](../../design/retrieval/design-vlad.md) §3.3 "尺度加权VLAD"
- 使用指南: [reference-scale-weighted-vlad-usage.md](../../reference/retrieval/reference-scale-weighted-vlad-usage.md)
