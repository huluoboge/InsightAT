...
**文件**: 
- `src/ui/widgets/SpatialReferenceTool.h`（历史路径）
- `src/ui/widgets/SpatialReferenceTool.cpp`（历史路径）
...
**文件**: 
- `src/ui/widgets/CoordinateSystemWidget.h`（历史路径）
- `src/ui/widgets/CoordinateSystemWidget.cpp`（历史路径）
