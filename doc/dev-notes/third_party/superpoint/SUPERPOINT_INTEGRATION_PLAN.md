...
- `doc/dev-notes/tools/isat_extract.md` (if exists, or create)
...
- Architecture Overview: `doc/develop/design/11_architecture_overview.md`
- Implementation Details: `doc/develop/design/12_implementation_details.md`
- Functional Toolkit: `doc/develop/design/04_functional_at_toolkit.md`
