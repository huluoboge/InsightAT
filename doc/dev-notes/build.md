...
IDC 自描述（JSON 头 + 二进制体），8 字节对齐，详见 [doc/dev-notes/design/](doc/dev-notes/design/)。
...
- [设计文档索引](doc/dev-notes/design/index.md) — 架构、数据模型、坐标系、序列化、UI
- [SfM 算法设计](doc/dev-notes/design/01_algorithm_sfm_philosophy.md) — 两层 SfM 设计思想
- [CLI I/O 规范](doc/dev-notes/design/05_cli_io_conventions.md) — 工具输入输出约定
...
InsightAT project code is licensed under the [MIT License](../LICENSE).

Third-party components retain their own licenses; see [THIRD_PARTY_LICENSES.md](../THIRD_PARTY_LICENSES.md). Default SIFT uses PopSift (MPL-2.0); optional SiftGPU has additional use restrictions.

---

## 🤝 Contributing

欢迎提 Issue 和 PR。开发前请阅读[编码规范](doc/dev-notes/design/02_coding_style.md)。
