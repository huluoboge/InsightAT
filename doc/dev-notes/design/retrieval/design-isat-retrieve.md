...
> 类型：`design`。本文记录 `isat_retrieve` 的策略、接口和架构设计；测试结果见 `imp/retrieval/`。
...
### 测试结果
详见: 
- [GPS/Sequential测试](../../imp/retrieval/imp-isat-retrieve-test-results.md)
- [VLAD快速入门](../../reference/retrieval/reference-vlad-quickstart.md) - 包含使用示例和故障排查
...
doc/dev-notes/tools/
├── design-isat-retrieve.md         # 本设计文档
├── imp-isat-retrieve-test-results.md # GPS测试报告
└── reference-vlad-quickstart.md    # VLAD使用指南（新）
```
