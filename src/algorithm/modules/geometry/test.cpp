...
static void bench(const char* label, RansacFn fn,
                  const Match2D* matches, int n, float thresh)
{
    float mat[9];
...
int main(void) {
    ...
    {
        float Hj[9], Hi[9];
        gpu_geo_set_solver(0); gpu_ransac_H(big, 100, Hj, 2.25f);
        gpu_geo_set_solver(1); gpu_ransac_H(big, 100, Hi, 2.25f);
