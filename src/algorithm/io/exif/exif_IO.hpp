...
struct SimpleExifHeader {
  ...
  template <class Archive> void save(Archive& ar) const {
    ...
    ar(GeoLocation.LatComponents.degrees, GeoLocation.LatComponents.minutes,
       GeoLocation.LatComponents.seconds, GeoLocation.LatComponents.direction);
    ar(GeoLocation.LonComponents.degrees, GeoLocation.LonComponents.minutes,
       GeoLocation.LonComponents.seconds, GeoLocation.LonComponents.direction);
  }
