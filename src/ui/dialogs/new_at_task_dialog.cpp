...
NewATTaskDialog::NewATTaskDialog(ProjectDocument* document, const QString& defaultName,
                                 QWidget* parent)
    : QDialog(parent), m_document(document), m_taskNameEdit(nullptr), m_parentTaskCombo(nullptr),
...
void NewATTaskDialog::onCancelClicked() { reject(); }
