...
void ProjectInfoDialog::initializeUI() {
  ...
  m_inputCoordDefLabel->setStyleSheet(
      "padding: 8px; background-color: #F5F5F5; border-radius: 3px;");
  ...
  connect(m_setCoordButton, &QPushButton::clicked, this,
          &ProjectInfoDialog::onSetInputCoordinateSystem);
...
void ProjectInfoDialog::onCancelEdit() { setEditingMode(false); }
