/**
 * @file  GPSPointsWizardDelegate.cpp
 * @brief 向导表格委托实现。
 */
...
//! [1]
QWidget* GPSPointsWizardDelegate::createEditor(QWidget* parent, const QStyleOptionViewItem& option,
...
//! [2]
void GPSPointsWizardDelegate::setEditorData(QWidget* editor, const QModelIndex& index) const {
  if (index.row() == 0) {
