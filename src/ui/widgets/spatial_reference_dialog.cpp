...
void SpatialReferenceDialog::init() {
  ...
  connect(ui.treeWidget_XYCoord, &QTreeWidget::clicked, this,
          &SpatialReferenceDialog::onItemClicked);

  // 连接其他按钮
  connect(ui.pushButton, &QPushButton::clicked, this, &SpatialReferenceDialog::onAddFavorite);
  connect(ui.lineEdit_filter, &QLineEdit::textChanged, this, &SpatialReferenceDialog::onFilter);
  connect(ui.pushButton_clearFilter, &QPushButton::clicked, this,
          &SpatialReferenceDialog::onClearFilter);
  connect(ui.pushButton_clearFavorite, &QPushButton::clicked, this,
          &SpatialReferenceDialog::onClearFavorite);
...
Coordinate SpatialReferenceDialog::SelectCoordinate() const { return _curCoordinate; }
...
void SpatialReferenceDialog::onClearFilter() { ui.lineEdit_filter->clear(); }
