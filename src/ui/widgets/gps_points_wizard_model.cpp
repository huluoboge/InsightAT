...
GPSPointsWizardModel::GPSPointsWizardModel(QObject* parent /*= NULL*/) : m_data(0) {}
...
QVariant GPSPointsWizardModel::data(const QModelIndex& index,
...
QVariant GPSPointsWizardModel::headerData(int section, Qt::Orientation orientation,
                                          int role /*= Qt::DisplayRole */) const {
  if (role == Qt::DisplayRole) {
...
bool GPSPointsWizardModel::setData(const QModelIndex& index, const QVariant& value,
