...
#include "dialogs/new_project_dialog.h"
#include "dialogs/project_info_dialog.h"
#include "models/project_document.h"
#include "models/workspace_tree_model.h"
#include "panels/at_task_panel.h"
#include "ui/utils/coordinates.h"
#include "widgets/image_groups_management_panel.h"
#include "widgets/spatial_reference_dialog.h"
...
void MainWindow::connect_signals_slots() {
  ...
  connect(m_imageGroupDetailDialog, &dialogs::ImageGroupDetailPanel::groupDataChanged, this,
          [this](uint32_t group_id) {
...
bool MainWindow::maybe_save() {
  ...
  QMessageBox::StandardButton reply = QMessageBox::question(
      this, tr("Unsaved Changes"), tr("The project has not been saved. Do you want to save it?"),
