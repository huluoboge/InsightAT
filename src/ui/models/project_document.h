...
public slots:
   ...
   * @return 成功返回true
   */
  bool newProject(const QString& name, const QString& author = "", const QString& description = "");
...
public slots:
   ...
   * 更新项目基本信息
   */
  void updateProjectInfo(const QString& name, const QString& author, const QString& description);
...
public slots:
   ...
   */
  uint32_t createImageGroup(const QString& name, insight::database::ImageGroup::CameraMode mode);
   ...
   */
  void updateGroupCamera(uint32_t group_id, const insight::database::CameraModel& camera);
...
public slots:
   ...
   * 向Rig添加相机挂载点
   */
  bool addCameraToRig(uint32_t rig_id, const insight::database::CameraRig::CameraMount& mount,
                      const insight::database::CameraModel& camera);
